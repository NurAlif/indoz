      ...
      <div className="mx-auto max-w-[1280px] px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <h2 className="text-3xl font-bold tracking-tight text-text-dark dark:text-white sm:text-4xl">
            ...
            <div className="pt-4">
              <button className="inline-flex items-center justify-center rounded-lg border-2 border-primary text-primary hover:bg-primary hover:text-white transition-colors px-6 py-3 text-base font-bold">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Card 1 */}
            <div className="group relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm hover:shadow-md transition-all hover:border-primary/30">
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <History className="h-24 w-24 text-primary" />
              </div>
              <div className="relative z-10 flex flex-col gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-red-100 dark:bg-red-900/30 text-primary">
                  <Briefcase className="h-6 w-6" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-text-dark dark:text-white">WHV (Working Holiday Visa)</h3>
            ...
            {/* Card 2 */}
            <div className="group relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm hover:shadow-md transition-all hover:border-[#D4AF37]/50">
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <Award className="h-24 w-24 text-[#D4AF37]" />
              </div>
              <div className="relative z-10 flex flex-col gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-text-dark dark:text-white">PR (Permanent Resident)</h3>
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <div className="group relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm hover:shadow-md transition-all hover:border-blue-500/30">
              ...
              <div className="relative z-10 flex flex-col gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-text-dark dark:text-white">Student Visa</h3>
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <div className="group relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm hover:shadow-md transition-all hover:border-green-500/30">
              ...
              <div className="relative z-10 flex flex-col gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-text-dark dark:text-white">EOI (Expression of Interest)</h3>
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
